...
def verifier_csv_et_notifier(csv_path="donnees_consolidees.csv"):
    """
    Étape 7 : Parcourt votre fichier CSV. Si une faille Critique ou Élevée
    concerne un éditeur surveillé par le client, génère et envoie l'e-mail.
    """
    ...
    # On filtre : on ne cherche que les vulnérabilités graves (Critique / Élevée)
    df_critique = df[df["Severite"].isin(["Critique", "Élevée"])]
...
- Niveau de sévérité : {ligne['Severite']}
- Score CVSS simulé : {ligne['CVSS']}/10
